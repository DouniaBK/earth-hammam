...
|Booking| form errors due to django form generation | see image below table|
...
The booking page has recurrent errors that were flagged due to the form generated by django that are inaccessible.
