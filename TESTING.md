...
|Booking| form errors due to django form generation | see validation error handling below|
...
The booking page has recurrent errors that were flagged due to the form auto-generated by Django that are inaccessible(see lines in images) no other errors relating to code written in this app were flagged by the validator.

![Booking form errors ](static/images/validation-error-django-form.png)
